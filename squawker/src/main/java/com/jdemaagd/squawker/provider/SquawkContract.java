...
/**
 * Uses Schematic (https://github.com/SimonVT/schematic) library
 * to define columns in a content provider baked by a database
 */
...
public class SquawkContract {
    ...
    /**
     * Create SQLite SELECTION parameter that filters for rows of authors currently following
     */
