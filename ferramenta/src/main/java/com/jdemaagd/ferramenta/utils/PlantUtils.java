package com.jdemaagd.ferramenta.utils;
...
public class PlantUtils {
    ...
    /**
     * Return corresponding image resource of plant
     *      given plant age and time since it was last watered
     *
    ...
    /**
     * Return corresponding image resource of plant given plant type, status, size (age category)
     *
     * @param context The context
     * @param type    The plant type (starts from 0 and corresponds to index to item in arrays.xml)
    ...
    /**
     * Return plant type display name based on type index from string resources
     *
     * @param context The context
     * @param type    The plant type (starts from 0 and corresponds to index to item in arrays.xml)
    ...
    /**
     * Convert age in milliseconds to displayable format (days, hours or minutes)
     *
